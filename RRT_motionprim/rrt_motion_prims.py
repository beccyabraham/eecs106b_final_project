...
class RRTMotionPrims(RRTStar):
    ...
    def __init__(self, start, goal, obstacle_list, rand_area,
        ...
        self.curvature = 1.0
        self.goal_yaw_th = np.deg2rad(360)
        self.goal_xy_th = 0.5
    ...
    def planning(self, animation=True, search_until_max_iter=True):
        ...
        for i in range(self.max_iter):
            ...
            if self.check_collision(new_node, self.obstacle_list):
                ...
                new_node = self.choose_parent(new_node, [nearest_ind])
                if new_node:
            ...
            if animation and i % 1 == 0:
                ...
                self.draw_graph(rnd, title="RRT, uniform sampling, 200 iterations")
    ...
    def draw_graph(self, rnd=None, title=""):
        plt.clf()
    ...
    def steer(self, from_node, to_node):
        px, py, pyaw, mode, course_lengths = reeds_shepp_path_planning.limited_path_planning(
...
def main(max_iter=200):
    ...
    rrt_motion_prims = RRTMotionPrims(start, goal,
                                             obstacleList,
